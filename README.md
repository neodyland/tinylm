...
DEV=NV JITBEAM=4 uv run python -m tinylm chat unsloth/Qwen3-0.6B --dtype bfloat16

# llm-jp/llm-jp-3.1-1.8b-instruct4を実行します。
DEV=NV JITBEAM=4 uv run python -m tinylm chat llm-jp/llm-jp-3.1-1.8b-instruct4 --dtype bfloat16
